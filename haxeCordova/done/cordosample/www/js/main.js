...
var SampleEvent = function(cb) {
	...
	if(this.g.get_isMobile()) {
		haxe.Log.trace("File.externalApplicationStorageDirectory=" + cordova.file.externalApplicationStorageDirectory,{ fileName : "SampleEvent.hx", lineNumber : 64, className : "SampleEvent", methodName : "new"});
		haxe.Log.trace("File.externalDataDirectory=" + cordova.file.externalDataDirectory,{ fileName : "SampleEvent.hx", lineNumber : 67, className : "SampleEvent", methodName : "new"});
		haxe.Log.trace("File.externalRootDirectory=" + cordova.file.externalRootDirectory,{ fileName : "SampleEvent.hx", lineNumber : 70, className : "SampleEvent", methodName : "new"});
	}
	if(this.callback != null) this.callback();
};
